...
export default function App() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ backgroundColor: '#FFF6E9', fontFamily: "'Be Vietnam Pro', sans-serif" }}>
      <style>{`
      ...
      <div className="relative z-10">
        <header className="pt-14 pb-10 px-6 text-center max-w-4xl mx-auto">
          ...
          <p style={{ fontFamily: "'Be Vietnam Pro', sans-serif", fontStyle: 'italic', fontSize: 'clamp(1.4rem, 3vw, 2rem)', color: '#7A1F3D', transform: 'rotate(-3deg)', display: 'inline-block' }}>
        ...
        <section className="max-w-2xl mx-auto px-6 mb-20">
          <div className="neo-card rounded-3xl p-7 md:p-9 border-[3px] relative"
            ...
            <p className="mb-6" style={{ fontFamily: "'Be Vietnam Pro', sans-serif", fontStyle: 'italic', fontSize: '1.25rem', color: '#666' }}>
            ...
            <label className="block mb-5">
              ...
              <textarea
                ...
                style={{ borderColor: '#1a1a1a', backgroundColor: '#FFF8F0', fontFamily: "'Be Vietnam Pro', sans-serif", fontStyle: 'italic', fontSize: '1.3rem', lineHeight: 1.4 }}
              />
            </label>
        ...
        <section className="max-w-7xl mx-auto px-6 pb-24">
          <div className="text-center mb-10">
            <p style={{ fontFamily: "'Be Vietnam Pro', sans-serif", fontStyle: 'italic', fontSize: '1.5rem', color: '#FF6B9D', transform: 'rotate(-2deg)', display: 'inline-block' }}>
          ...
          {loading ? (
            ...
            <div className="text-center py-16 rounded-3xl border-[3px] border-dashed max-w-xl mx-auto"
              ...
              <p style={{ fontFamily: "'Be Vietnam Pro', sans-serif", fontStyle: 'italic', fontSize: '1.4rem', color: '#666' }}>Bạn là người đầu tiên đó! 💪</p>
            </div>
          ) : (
        ...
        <footer className="text-center pb-10 px-6">
          <div className="inline-flex items-center gap-2" style={{ fontFamily: "'Be Vietnam Pro', sans-serif", fontStyle: 'italic', fontSize: '1.3rem', color: '#666' }}>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ fontFamily: "'Be Vietnam Pro', sans-serif", fontStyle: 'italic', fontSize: '1.45rem', lineHeight: 1.35, fontWeight: 600, whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>
          {wish.message}
        </p>
        ...
        <div className="mt-5 pt-3 flex items-center justify-between gap-2"
          ...
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            <span className="font-bold text-sm truncate" style={{ fontFamily: "'Be Vietnam Pro', sans-serif" }}>
              {wish.name}
            </span>
          </div>
